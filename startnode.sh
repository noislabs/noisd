...
noisd genesis add-genesis-account "$VALIDATOR_ADDR" 500000000000000unois
# add initial community pool balance of 10000 NOIS
noisd genesis add-genesis-account nois103y4f6h80lc45nr8chuzr3fyzqywm9n0d8fxzu 10000000000unois
noisd genesis gentx validator 1000000unois --chain-id localnet-1 --details "1"
noisd genesis collect-gentxs
noisd genesis validate-genesis
